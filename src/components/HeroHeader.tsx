        ...
        <header className="flex flex-col w-full">
            ...
            <div className="flex flex-col pt-[150px] pb-10 px-[120px] gap-10 bg-[#0D903A]">
                <div className="logo-contianer flex items-center justify-center flex-wrap max-w-[1130px] h-[38px] mx-auto gap-[60px]">
                    <Image width={128} height={56} src="/assets/images/logos/TESLA.svg" alt="clients logo" />
                    <Image width={128} height={56} src="/assets/images/logos/Libra 2.svg" alt="clients logo" />
                    <Image width={128} height={56} src="/assets/images/logos/Binance logo.svg" alt="clients logo" />
                    <Image width={128} height={56} src="/assets/images/logos/Facebook 7.svg" alt="clients logo" />
                    <Image width={128} height={56} src="/assets/images/logos/Microsoft 6.svg" alt="clients logo" />
                </div>
